...
func TestParsePermalink(t *testing.T) {
	cases := []struct {
		...
		{
			name:        "single message",
			in:          "https://example.slack.com/archives/C0123456789/p1716000000123456",
			wantChannel: "C0123456789",
			wantTS:      "1716000000.123456",
		},
		{
			name:        "thread reply",
			in:          "https://example.slack.com/archives/C0123456789/p1716000001000000?thread_ts=1716000000.123456&cid=C0123456789",
			wantChannel: "C0123456789",
